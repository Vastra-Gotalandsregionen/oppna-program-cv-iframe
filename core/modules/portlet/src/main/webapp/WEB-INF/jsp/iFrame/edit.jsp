...
<form:form method="post" action="${formAction}" commandName="portletConfig">
    ...
    <fieldset>
        ...
        <table class="lfr-table">
            <tr>
                <td><label for="<portlet:namespace/>allowedBrowsersRegExp">RegExp to validate allowed browsers</label>
                </td>
                <td><form:input path="allowedBrowsersRegExp" id="${ns}allowedBrowsersRegExp" size="80"/></td>
            </tr>
            <tr>
                <td colspan="2">Example: If you want to ensure that the client is using Internet Explorer 5-8 then type
                    in '.*MSIE [5678].*'
                </td>
            </tr>
            <tr>
                <td><label for="<portlet:namespace/>allowedBrowsersViolationMessage">Message to present if browser
